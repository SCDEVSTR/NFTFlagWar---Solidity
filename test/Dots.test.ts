...
describe(name, () => {
  ...
  it('should not vest while game is continuing', async () => {
    ...
    await contract.claimLocation(0, 0, 1, { value: String(BASE_PRICE) });
    await contract.claimLocation(0, 1, 1, { value: String(BASE_PRICE) });
  ...
  //   // Transaction 1
  //   const tx1 = await contract.claimLocation(0, 0, 1, {
  //     value: String(BASE_PRICE),
  //   });
  ...
  //   // Transaction 2
  //   const tx2 = await contract.claimLocation(0, 1, 1, {
  //     value: String(BASE_PRICE),
  //   });
  ...
  //   );
  //   // Transaction 3
  //   const tx3 = await contract.pauseGame();
  ...
  it('should track vest stakes properly', async () => {
    ...
    await contract.claimLocation(0, 0, 1, { value: String(BASE_PRICE) });
    await contract.claimLocation(0, 1, 1, { value: String(BASE_PRICE) });
    await contractAsSigner0.claimLocation(0, 1, 5, {
